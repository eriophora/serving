...
_INCEPTIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='image_data', full_name='tensorflow.serving.InceptionRequest.image_data', index=0,
...
_INCEPTIONREQUEST.fields_by_name['image_data'].has_options = True
_INCEPTIONREQUEST.fields_by_name['image_data']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
import abc
import six
